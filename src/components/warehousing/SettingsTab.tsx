// src/components/warehousing/SettingsTab.tsx
...
const links = [
    { id: 'carriers', name: 'Carriers', description: 'Create and update carriers', icon: <LocalShippingIcon /> },
];
            ...
            <Grid container spacing={4}>
                {links.map((item) => (
                    <Grid item xs={12} sm={6} md={4} lg={3} key={item.id}>
                        <Link href={`/navigation/warehousing/settings/${item.id}`} passHref>
                            <Card
